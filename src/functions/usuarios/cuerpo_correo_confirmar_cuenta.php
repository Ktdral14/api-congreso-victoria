    ...
    public function GetBody()
    {
        ...
        <body>
            <div class="container d-flex flex-column justify-content-center mt-5 align-items-center">
                <div class=" ">
                    <p style="font-size: 30px; "><strong>Confirma tu correo para poder acceder a la plataforma</strong> </p>
                </div>
                <div>
                    <p style="font-size: 20px; ">Para confirmar tu correo solo preciona el boton de abajo.</p>
                </div>
                <div>
                    <a href="' . $this->link_cambiar_contrasena . '" class="btn btn-primary ">Confirmar correo</a>
                </div>
            </div>
